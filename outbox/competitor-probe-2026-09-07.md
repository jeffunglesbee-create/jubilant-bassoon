# Competitor Metrics Probe — 2026-09-07
...
### ⚠️ Stuff+
**FIELD relay:** `/mlb-stats/pitch_arsenals.json` — ok (80230 bytes)
...
### ⚠️ Barrel Rate
**FIELD relay:** `/mlb-stats/expected_stats.json` — ok (43784 bytes)
...
**FIELD relay:** `/nflverse/ngs-receiving.json` — ok (57570 bytes)
...
**FIELD relay:** `/nflverse/ngs-passing.json` — ok (17196 bytes)
