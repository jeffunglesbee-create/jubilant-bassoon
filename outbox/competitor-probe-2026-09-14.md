# Competitor Metrics Probe — 2026-09-14
...
### ⚠️ Stuff+
**FIELD relay:** `/mlb-stats/pitch_arsenals.json` — ok (84540 bytes)
...
### ⚠️ Barrel Rate
**FIELD relay:** `/mlb-stats/expected_stats.json` — ok (44378 bytes)
...
**FIELD relay:** `/nflverse/ngs-receiving.json` — ok (2282 bytes)
...
**FIELD relay:** `/nflverse/ngs-passing.json` — ok (1163 bytes)
