# Competitor Metrics Probe — 2026-08-17
...
### ⚠️ Stuff+
**FIELD relay:** `/mlb-stats/pitch_arsenals.json` — ok (61450 bytes)
...
### ⚠️ Barrel Rate
**FIELD relay:** `/mlb-stats/expected_stats.json` — ok (41258 bytes)
...
### ✅ Success Rate (NFL)
**FIELD relay:** `/nflverse/player-stats.json` — ok (283732 bytes)
