# Competitor Metrics Probe — 2026-09-21
...
### ⚠️ Stuff+
**FIELD relay:** `/mlb-stats/pitch_arsenals.json` — ok (90443 bytes)
...
### ⚠️ Barrel Rate
**FIELD relay:** `/mlb-stats/expected_stats.json` — ok (44798 bytes)
...
**FIELD relay:** `/nflverse/ngs-receiving.json` — ok (33357 bytes)
...
**FIELD relay:** `/nflverse/ngs-passing.json` — ok (8997 bytes)
