# Competitor Metrics Probe — 2026-08-24
...
### ⚠️ Stuff+
**FIELD relay:** `/mlb-stats/pitch_arsenals.json` — ok (69067 bytes)
...
### ⚠️ Barrel Rate
**FIELD relay:** `/mlb-stats/expected_stats.json` — ok (41902 bytes)
...
**FIELD relay:** `/nflverse/ngs-receiving.json` — ok (57581 bytes)
...
### ✅ Success Rate (NFL)
**FIELD relay:** `/nflverse/player-stats.json` — ok (283764 bytes)
...
**FIELD relay:** `/nflverse/ngs-passing.json` — ok (17189 bytes)
