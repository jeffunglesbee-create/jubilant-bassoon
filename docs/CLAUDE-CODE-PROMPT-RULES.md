...
Rule 91 (SCOPE-LEGIBLE-A) — see STANDARDS.md for full text. Durability
and holism are the same test applied at four radii (process, repo,
cross-repo, session) — is a fact or piece of state legible to whoever
needs to see it, checked BEFORE acting, at the boundary that fact
actually crosses. Canonicalized 2026-07-11 (this document previously
carried the full text locally, numbered Rule 89 — a second, uncoordinated
numbering authority; this document stays a Claude-Code-specific reading
companion and does not originate rules).
