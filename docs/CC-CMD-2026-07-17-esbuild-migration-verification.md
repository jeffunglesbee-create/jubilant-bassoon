...
Exact line range of the override itself in the real, full `index.html` (correct for the script-block extraction offset). Document the same zero-before/177-after finding with real evidence in the outbox.
