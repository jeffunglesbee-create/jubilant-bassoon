...
- Handoff Note (read first): `1sIgtMkQultNdxwSvW7YvFV0sA7iU-2yU` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1sIgtMkQultNdxwSvW7YvFV0sA7iU-2yU` | Every session end — replace ID with new handoff doc |
