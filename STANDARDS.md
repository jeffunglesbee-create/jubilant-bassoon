...
- Handoff Note (read first): `1SeKWLFabBKNhvX4-7Yee_p5EzIq3hbCD` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1SeKWLFabBKNhvX4-7Yee_p5EzIq3hbCD` | Every session end — replace ID with new handoff doc |
