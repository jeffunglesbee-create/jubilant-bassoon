...
- Handoff Note (read first): `1rK2KXUMLs7pzpy8sncKtw8BNJd7zdMr8` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1rK2KXUMLs7pzpy8sncKtw8BNJd7zdMr8` | Every session end — replace ID with new handoff doc |
