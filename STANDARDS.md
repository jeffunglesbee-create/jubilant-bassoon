...
- Handoff Note (read first): `1oQUepxN5fUJ2UNs6NilRQvaoIHPi-Ysn` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1oQUepxN5fUJ2UNs6NilRQvaoIHPi-Ysn` | Every session end — replace ID with new handoff doc |
