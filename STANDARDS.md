...
- Handoff Note (read first): `1J2qu1QE2Fja9FwePo-_yJ72_i4nRzuK7` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1J2qu1QE2Fja9FwePo-_yJ72_i4nRzuK7` | Every session end — replace ID with new handoff doc |
