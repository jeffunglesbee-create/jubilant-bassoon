...
- Handoff Note (read first): `1_LkNFGPsqyiYzhrGbVzSJOTJbqUvu__-` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1_LkNFGPsqyiYzhrGbVzSJOTJbqUvu__-` | Every session end — replace ID with new handoff doc |
