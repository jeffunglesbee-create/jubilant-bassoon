...
- Handoff Note (read first): `1dOIdCqpZaCQoccgxJh8d1yeZDWH1YrdQGoDAjYcshXs` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1dOIdCqpZaCQoccgxJh8d1yeZDWH1YrdQGoDAjYcshXs` | Every session end — replace ID with new handoff doc |
