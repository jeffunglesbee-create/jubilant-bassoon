...
- Handoff Note (read first): `1WeaaDz8k3j8fkqaWZSCXrfdeVw_kBZXE` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1WeaaDz8k3j8fkqaWZSCXrfdeVw_kBZXE` | Every session end — replace ID with new handoff doc |
