...
- Handoff Note (read first): `1aHMLPdy9dRkl90UWb3jyTVvP9zG61F4l` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1aHMLPdy9dRkl90UWb3jyTVvP9zG61F4l` | Every session end — replace ID with new handoff doc |
