...
- Handoff Note (read first): `1tqg4xH4h0AlcnxAB9JN486zCbqv2MM1Cubl5IfPprhU` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1tqg4xH4h0AlcnxAB9JN486zCbqv2MM1Cubl5IfPprhU` | Every session end — replace ID with new handoff doc |
