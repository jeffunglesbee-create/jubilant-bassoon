...
- Handoff Note (read first): `1aGsGnMP0RDWG5gj0nCdvbg3MNhzjxWFRFdjfQ-4aRAc` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1aGsGnMP0RDWG5gj0nCdvbg3MNhzjxWFRFdjfQ-4aRAc` | Every session end — replace ID with new handoff doc |
