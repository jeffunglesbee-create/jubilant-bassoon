...
- Handoff Note (read first): `1XuOSlKsdmEc70kqp3DIlrNpnpo40Zl-_IOfEV_HEsiQ` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1XuOSlKsdmEc70kqp3DIlrNpnpo40Zl-_IOfEV_HEsiQ` | Every session end — replace ID with new handoff doc |
