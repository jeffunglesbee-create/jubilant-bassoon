...
- Handoff Note (read first): `1c-G2yTPvigM-SHN8O1j6MMVeGu1mJjA7` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1c-G2yTPvigM-SHN8O1j6MMVeGu1mJjA7` | Every session end — replace ID with new handoff doc |
