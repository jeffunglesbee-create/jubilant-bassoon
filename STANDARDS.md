...
- Handoff Note (read first): `1d6aO5IaGpe4Ok1zSJ3oeXGS22XwEhm8RY_vO1JKpOZA` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1d6aO5IaGpe4Ok1zSJ3oeXGS22XwEhm8RY_vO1JKpOZA
Session doc May 22 (Night Owl): no separate session doc` | Every session end — replace ID with new handoff doc |
