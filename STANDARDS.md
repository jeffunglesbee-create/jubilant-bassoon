...
- Handoff Note (read first): `1FVkpyO8q5Rf9LYtTLit0S-cUe33fsV6KTFxWm6JwzpI` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1FVkpyO8q5Rf9LYtTLit0S-cUe33fsV6KTFxWm6JwzpI` | Every session end — replace ID with new handoff doc |
