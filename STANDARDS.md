...
- Handoff Note (read first): `14aDAIYp555btMp2pVuzoGPgYA0f8Rvro549MGxnVUTM` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `14aDAIYp555btMp2pVuzoGPgYA0f8Rvro549MGxnVUTM` | Every session end — replace ID with new handoff doc |
