...
- Handoff Note (read first): `1Zc-sYd1hDeNNBzBnf3CusnQCrF3iLQf4` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1Zc-sYd1hDeNNBzBnf3CusnQCrF3iLQf4` | Every session end — replace ID with new handoff doc |
