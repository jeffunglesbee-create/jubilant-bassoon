...
- Handoff Note (read first): `1P0cQQouF_kF7lGDNTZHSYOhaxbguocTY` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1P0cQQouF_kF7lGDNTZHSYOhaxbguocTY` | Every session end — replace ID with new handoff doc |
