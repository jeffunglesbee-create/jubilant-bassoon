...
- Handoff Note (read first): `1y2cjRljlK5bPI1CzPzRRXpOug5SEwLBPgdzwEal3I_A` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1y2cjRljlK5bPI1CzPzRRXpOug5SEwLBPgdzwEal3I_A` | Every session end — replace ID with new handoff doc |
