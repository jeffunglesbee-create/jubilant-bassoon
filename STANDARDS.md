...
- Handoff Note (read first): `155g2bxbhr3_9iScoRpZiqLUziTxEwN7Ml6WzFsX_VTI` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `155g2bxbhr3_9iScoRpZiqLUziTxEwN7Ml6WzFsX_VTI` | Every session end — replace ID with new handoff doc |
