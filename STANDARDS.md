...
- Handoff Note (read first): `110RjEPFsib3BMs5DSXToc8YDYqXOL6lUTVGxqBZ8YjQ` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `110RjEPFsib3BMs5DSXToc8YDYqXOL6lUTVGxqBZ8YjQ` | Every session end — replace ID with new handoff doc |
