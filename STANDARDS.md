...
- Handoff Note (read first): `18l0CcQR4oHKAWJts_YyMeppW149aJ2lH9zCPEm7jUVU` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `18l0CcQR4oHKAWJts_YyMeppW149aJ2lH9zCPEm7jUVU` | Every session end — replace ID with new handoff doc |
