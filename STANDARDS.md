...
- Handoff Note (read first): `1ZjOoYuBcG0_5pJskf9KIF7OYz9yPmPvM` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1ZjOoYuBcG0_5pJskf9KIF7OYz9yPmPvM` | Every session end — replace ID with new handoff doc |
