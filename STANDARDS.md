...
- Handoff Note (read first): `1hXXodQ3tsFSGtLq38rxRd8bm6V15CZh_` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1hXXodQ3tsFSGtLq38rxRd8bm6V15CZh_` | Every session end — replace ID with new handoff doc |
