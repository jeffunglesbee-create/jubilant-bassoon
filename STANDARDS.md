...
- Handoff Note (read first): `1UWdJVPi_sZ6UkD1RJHUEJysozB6G35Nd` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1UWdJVPi_sZ6UkD1RJHUEJysozB6G35Nd` | Every session end — replace ID with new handoff doc |
