...
- Handoff Note (read first): `1oY-mmTe6Ae0qRqcWKiPdVRrv8QoL7x-1clsdo_sLQ0o` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1oY-mmTe6Ae0qRqcWKiPdVRrv8QoL7x-1clsdo_sLQ0o` | Every session end — replace ID with new handoff doc |
