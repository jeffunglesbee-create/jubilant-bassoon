...
- Handoff Note (read first): `1XIzYX_kn22omxIjatPA9kPxcJgNxbx66` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1XIzYX_kn22omxIjatPA9kPxcJgNxbx66` | Every session end — replace ID with new handoff doc |
