...
- Handoff Note (read first): `1eldP7gvxyMGkVAUgOCCm3_36SohYssrqyev3Q-mXuTU` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1eldP7gvxyMGkVAUgOCCm3_36SohYssrqyev3Q-mXuTU` | Every session end — replace ID with new handoff doc |
