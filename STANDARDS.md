...
- Handoff Note (read first): `1WwyATk0wV-G_kArtrg48Dj1yiSBRQg5x` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1WwyATk0wV-G_kArtrg48Dj1yiSBRQg5x` | Every session end — replace ID with new handoff doc |
