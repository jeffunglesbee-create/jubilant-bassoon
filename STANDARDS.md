...
- Handoff Note (read first): `1u9LWE_dN1Y_IbMUzFHva60Fywf52F2lM` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1u9LWE_dN1Y_IbMUzFHva60Fywf52F2lM` | Every session end — replace ID with new handoff doc |
