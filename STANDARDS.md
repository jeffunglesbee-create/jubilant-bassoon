...
- Handoff Note (read first): `1-Oh4Di9dRrVmDtmmLLMoQVImMO5W2Cxv` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1-Oh4Di9dRrVmDtmmLLMoQVImMO5W2Cxv` | Every session end — replace ID with new handoff doc |
