...
- Handoff Note (read first): `1ZYzdTJ-vBdCG6AF7LInFSAnfQEejJ5ztbTVziaOpxA0` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1ZYzdTJ-vBdCG6AF7LInFSAnfQEejJ5ztbTVziaOpxA0` | Every session end — replace ID with new handoff doc |
