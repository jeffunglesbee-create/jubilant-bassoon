...
- Handoff Note (read first): `1zZjoBPpC9acP18t0GPS0OZIli5_TQEgf1LzEaz3sP48` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1zZjoBPpC9acP18t0GPS0OZIli5_TQEgf1LzEaz3sP48` | Every session end — replace ID with new handoff doc |
