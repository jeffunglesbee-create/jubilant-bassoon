...
- Handoff Note (read first): `1inzkoN3gLdEXqWX1lVTid6c8T3UXIpbAszs-X_DE4GU` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1inzkoN3gLdEXqWX1lVTid6c8T3UXIpbAszs-X_DE4GU` | Every session end — replace ID with new handoff doc |
