...
- Handoff Note (read first): `1Q7ab_J-cn8Lb40Ri3-r9i46qgwcg_42hdDcpidKyLRc` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1Q7ab_J-cn8Lb40Ri3-r9i46qgwcg_42hdDcpidKyLRc` | Every session end — replace ID with new handoff doc |
