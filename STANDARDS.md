...
- Handoff Note (read first): `1JmS8Bnv7MxCaxuBhFpb1uXD4nfDKnP7rMNeRvLJo82s` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1JmS8Bnv7MxCaxuBhFpb1uXD4nfDKnP7rMNeRvLJo82s` | Every session end — replace ID with new handoff doc |
