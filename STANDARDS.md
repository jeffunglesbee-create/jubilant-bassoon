...
- Handoff Note (read first): `1Edftnd8oNJR2ZDmo1hAQVklPl7rW99Ab` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1Edftnd8oNJR2ZDmo1hAQVklPl7rW99Ab` | Every session end — replace ID with new handoff doc |
