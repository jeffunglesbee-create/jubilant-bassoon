...
- Handoff Note (read first): `1GDpWzM2pLMAsSsmCLqSnRPp-qRYQIiJnNTDZmS00tFc` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1GDpWzM2pLMAsSsmCLqSnRPp-qRYQIiJnNTDZmS00tFc` | Every session end — replace ID with new handoff doc |
