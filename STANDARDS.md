...
- Handoff Note (read first): `1MnTLEb01w84iHDOVBO-07ULaleZAfdqYTaqctCqvVpc` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1MnTLEb01w84iHDOVBO-07ULaleZAfdqYTaqctCqvVpc` | Every session end — replace ID with new handoff doc |
