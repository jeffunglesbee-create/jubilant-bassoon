...
- Handoff Note (read first): `165MKSyfRr9EeRLIVtExYcT0p8GnOv3Ez` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `165MKSyfRr9EeRLIVtExYcT0p8GnOv3Ez` | Every session end — replace ID with new handoff doc |
