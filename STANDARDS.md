...
- Handoff Note (read first): `17G1Zs1P_lLRg72A8KrvGLBxxwEvkT7Cz` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `17G1Zs1P_lLRg72A8KrvGLBxxwEvkT7Cz` | Every session end — replace ID with new handoff doc |
