...
- Handoff Note (read first): `1OlQEIzo0YyD0HU7djXNOFQYOjyLz6Guv-dpPZ40CWek` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1OlQEIzo0YyD0HU7djXNOFQYOjyLz6Guv-dpPZ40CWek` | Every session end — replace ID with new handoff doc |
