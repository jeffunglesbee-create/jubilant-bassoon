...
- Handoff Note (read first): `1GOyrIiuLZQJQhgA9gvBIt02wL0rypNdO2ea5wLtOY4c` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1GOyrIiuLZQJQhgA9gvBIt02wL0rypNdO2ea5wLtOY4c` | Every session end — replace ID with new handoff doc |
