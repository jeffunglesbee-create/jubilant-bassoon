...
- Handoff Note (read first): `1cEW-u6ROkvWhrhq1apxtXgQIUIGzOy1V` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1cEW-u6ROkvWhrhq1apxtXgQIUIGzOy1V` | Every session end — replace ID with new handoff doc |
