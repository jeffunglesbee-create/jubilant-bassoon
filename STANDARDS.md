...
- Handoff Note (read first): `1t8iyFvRlM_lK56n1zZIW1xi244mZiH8Uk96cyR52BL8` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1t8iyFvRlM_lK56n1zZIW1xi244mZiH8Uk96cyR52BL8` | Every session end — replace ID with new handoff doc |
