...
- Handoff Note (read first): `1ACx0kFg5Vduyc0dTsmaF-FSf8xmG3yzPXSAjkuNQsKQ` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1ACx0kFg5Vduyc0dTsmaF-FSf8xmG3yzPXSAjkuNQsKQ` | Every session end — replace ID with new handoff doc |
