...
- Handoff Note (read first): `1l0AddAXuYYZOf_sfnuxNH1auKIYEr0YzJs_X5xAqd_w` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1l0AddAXuYYZOf_sfnuxNH1auKIYEr0YzJs_X5xAqd_w` | Every session end — replace ID with new handoff doc |
