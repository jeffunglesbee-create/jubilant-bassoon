...
- Handoff Note (read first): `17CiorXZvc5EgGgejg8UixYJ-I8GcnTegZpLC-Teujws` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `17CiorXZvc5EgGgejg8UixYJ-I8GcnTegZpLC-Teujws` | Every session end — replace ID with new handoff doc |
