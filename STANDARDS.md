...
- Handoff Note (read first): `1_6BBX3XZm1Cci0_SoY-qxRlc_dF_aw-f` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1_6BBX3XZm1Cci0_SoY-qxRlc_dF_aw-f` | Every session end — replace ID with new handoff doc |
