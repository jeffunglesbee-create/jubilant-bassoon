...
- Handoff Note (read first): `1-0TityUul4Fn4XG12Jeb-pSXddgd4hIBY4G9lhKTGS4` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1-0TityUul4Fn4XG12Jeb-pSXddgd4hIBY4G9lhKTGS4` | Every session end — replace ID with new handoff doc |
