...
- Handoff Note (read first): `1mJcZuhVaQ9stpyDhJXmn2N4zZ9902Ugk` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1mJcZuhVaQ9stpyDhJXmn2N4zZ9902Ugk` | Every session end — replace ID with new handoff doc |
