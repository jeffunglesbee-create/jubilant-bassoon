...
- Handoff Note (read first): `118wrUaQFcgJvD-dZ3vXikg_XiG8AR7PB` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `118wrUaQFcgJvD-dZ3vXikg_XiG8AR7PB` | Every session end — replace ID with new handoff doc |
