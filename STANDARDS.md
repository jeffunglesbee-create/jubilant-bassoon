...
- Handoff Note (read first): `1LMTdr_iSnTNNMWuRm5N6s-NA86Llxdh6MbFJiABy5P4` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1LMTdr_iSnTNNMWuRm5N6s-NA86Llxdh6MbFJiABy5P4` | Every session end — replace ID with new handoff doc |
