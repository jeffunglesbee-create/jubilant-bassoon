...
- Handoff Note (read first): `1dPm-aqURPpETujivi9MknNNkmVIAwkvHeQyOfp8T21M` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1dPm-aqURPpETujivi9MknNNkmVIAwkvHeQyOfp8T21M` | Every session end — replace ID with new handoff doc |
