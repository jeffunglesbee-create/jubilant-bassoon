...
- Handoff Note (read first): `1GH4u6DdSjz7NyW-K0SmQThBu256OJdrI` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1GH4u6DdSjz7NyW-K0SmQThBu256OJdrI` | Every session end — replace ID with new handoff doc |
