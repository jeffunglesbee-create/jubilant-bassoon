...
- Handoff Note (read first): `1KheNq14Iy3QzgRQk2VUGobX9J1FBEzkX` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1KheNq14Iy3QzgRQk2VUGobX9J1FBEzkX` | Every session end — replace ID with new handoff doc |
