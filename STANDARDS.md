...
- Handoff Note (read first): `1BiWxkIDhR6H4ecjwPVawtk1XYZlhlxXv` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1BiWxkIDhR6H4ecjwPVawtk1XYZlhlxXv` | Every session end — replace ID with new handoff doc |
