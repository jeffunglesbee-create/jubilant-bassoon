...
- Handoff Note (read first): `1dEx6hcGG_iYZKlVMpUphEWZDqwkVcNq-pbz9ZHSetGQ` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1dEx6hcGG_iYZKlVMpUphEWZDqwkVcNq-pbz9ZHSetGQ` | Every session end — replace ID with new handoff doc |
