...
- Handoff Note (read first): `1zJEd7VYW9w2UwqzjmLe5sv300J5DKL0X` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1zJEd7VYW9w2UwqzjmLe5sv300J5DKL0X` | Every session end — replace ID with new handoff doc |
