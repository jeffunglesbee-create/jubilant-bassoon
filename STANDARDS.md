...
- Handoff Note (read first): `1JS60NC5fKcg-2qqEx4js3HThZgHTcmhz` ← update this ID every session end
...
| **Handoff Note** ← update ID every session | `1JS60NC5fKcg-2qqEx4js3HThZgHTcmhz` | Every session end — replace ID with new handoff doc |
